                                ...
                                <div class="card-body">
                                    <form method="POST" action="/admin/users">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="inputpassword" type="password" class="form-control form-control-lg" name="password_confirmation" required autocomplete="new-password" placeholder="Comfirm Password">
                                        </div>
                                        <div class="form-group">
