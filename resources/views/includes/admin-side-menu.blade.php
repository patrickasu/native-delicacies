                                ...
                                <li class="nav-item">
                                    ...
                                    <div id="submenu-1-1" class="collapse submenu" style="">
                                        <ul class="nav flex-column">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link" href="/admin/food-categories/create">Create A New Category <span class="badge badge-secondary">New</span></a>
                                            </li>
                                        </ul>
                                    </div>
                                </li>
                ...
                <li class="nav-item">
                    ...
                    <div id="submenu-5" class="collapse submenu" style="">
                        <ul class="nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="/admin/settings/social-media">Social Media <span class="badge badge-secondary">New</span></a>
                            </li>
                        </ul>
                    </div>
                </li> 
